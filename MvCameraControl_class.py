...
class MvCamera():
    ...
    def MV_CC_EnumInterfacesByGenTL(self, stIFList, strGenTLPath):
    ...
    def MV_CC_EnumDevicesByGenTL(self, stIFInfo, stDevList):
        ...
        return MvCamCtrldll.MV_CC_EnumDevicesByGenTL(byref(stIFInfo), byref(stDevList))
